        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            <motion.div initial={{ opacity: 0, scale: 0 }} 
              ...
              className="absolute -top-4 -left-4 glass-effect rounded-xl p-4 floating-animation" 
            ...
            <motion.div 
              ...
              className="absolute -bottom-4 -right-4 glass-effect rounded-xl p-4 floating-animation" 
