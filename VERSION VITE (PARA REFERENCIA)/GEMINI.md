...
Este documento proporciona un resumen completo del proyecto "Zona Vortex" de la version vite, una aplicación web construida con React y Supabase. Este documento es mas para referencia de como se estructuró la version vito que se va a migrar a next js
